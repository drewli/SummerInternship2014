...
public class CreatingProviderGroup {
	...
	public static void main(String[] args) {
        ...
        element.clear();
        element.sendKeys(new String[]{"A test provider group."});
		...
		try {
			...
			driver.close();
			driver.switchTo().window(parentWindowHandler);
			System.out.println("The add provider group window was still open after saving " + 
        ...
        for (int i = 0; true; i++){
        	...
        	if (i == 200) {
        		System.out.println("Provider Group could not be created.");
        		break;
        	}
        	try {
