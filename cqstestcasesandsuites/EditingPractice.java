...
public class EditingPractice {
	public static void main(String[] args) {
        ...
        element.clear();
        element.sendKeys(new String[]{"N/A"});
		...
		try {
			...
			driver.close();
			driver.switchTo().window(parentWindowHandler);
			System.out.println("The edit practice window was still open after saving " + 
        ...
        for (int i = 0; true; i++){
        	...
        	if (i == 200) {
        		System.out.println("Name of Practice could not be changed.");
        		break;
        	}
        	try {
        		element = driver.findElement(By.xpath("//div[@id=\'list_list_body\']/div/div"));
        ...
        for (int i = 0; true; i++){
        	...
        	if (i == 200) {
        		System.out.println("Description of Practice could not be changed.");
        		break;
        	}
        	try {
        		element = driver.findElement(By.xpath("//div[@id=\'list_list_body\']/div/div"));
