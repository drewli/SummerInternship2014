...
public class EditingProviderGroup {
	...
	public static void main(String[] args) {
        ...
        element.clear();
        element.sendKeys(new String[]{"Andrew\'s Provider Group"});
        ...
        element.clear();
        element.sendKeys(new String[]{"A testB provider group."});
        ...
        for (int i = 0; true; i++){
        	...
        	if (i == 200) {
        		System.out.println("Name of Provider Group could not be changed.");
        		break;
        	}
        	try {
        		element = driver.findElement(By.xpath("//div[@id=\'list_list_body\']/div/div"));
        ...
        for (int i = 0; true; i++){
        	...
        	if (i == 200) {
        		System.out.println("Description of Provider Group could not be changed.");
        		break;
        	}
        	try {
        		element = driver.findElement(By.xpath("//div[@id=\'list_list_body\']/div/div"));
