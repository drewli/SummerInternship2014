...
public class EditingDashboardView {
	...
	public static void main(String[] args) {
        ...
        element.clear();
        element.sendKeys(new String[]{"New View54"});
        element = driver.findElement(By.id("title"));
        element.clear();
        element.sendKeys(new String[]{"Not Available2"});
		...
		try {
			...
			driver.close();
			driver.switchTo().window(parentWindowHandler);
			System.out.println("The edit Dashboard View window was still open after saving " + 
        ...
        for (int i = 0; true; i++){
        	...
        	if (i == 200) {
        		System.out.println("Name of Dashboard View could not be changed.");
        		break;
        	}
        	try {
        		element = driver.findElement(By.xpath("//div[@id=\'list_list_body\']/div/div"));
        ...
        for (int i = 0; true; i++){
        	...
        	if (i == 200) {
        		System.out.println("Description of Dashboard View could not be changed.");
        		break;
        	}
        	try {
        		element = driver.findElement(By.xpath("//div[@id=\'list_list_body\']/div/div"));
