...
public class EditingProvider {
	...
	public static void main(String[] args) {
        ...
        element = driver.findElement(By.id("npi_number"));
        element.clear();
        element.sendKeys(new String[]{"1209128065"});
        element = driver.findElement(By.id("last_name"));
        element.clear();
        element.sendKeys(new String[]{"Collins"});
        element = driver.findElement(By.id("first_name"));
		element.clear();
		element.sendKeys(new String[]{"Alexander"});
		...
		try {
			...
			driver.close();
			driver.switchTo().window(parentWindowHandler);
			System.out.println("The edit provider window was still open after saving " + 
        ...
        element = driver.findElement(By.id("filter"));
        element.clear();
        element.sendKeys(new String[]{"Collins, Alexander"});
        element = driver.findElement(By.id("search_btn"));
        element.click();
        for (int i = 0; true; i++){
        	try {
        	...
        	if (i == 200) {
        		System.out.println("Provider could not be edited.");
        		break;
        	}
        	try {
        		element = driver.findElement(By.xpath("//div[@id=\'list_list_body\']/div/div"));
